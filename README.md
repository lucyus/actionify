...
* [**VII. Window Manager**](./docs/WINDOW.md)
  ...
  * [3. Window Events](./docs/WINDOW.md#3-window-events)
    * [3.1. Window Event Types](./docs/WINDOW.md#31-window-event-types)
    * [3.2. Listening to Window Events](./docs/WINDOW.md#32-listening-to-window-events)
      * [3.2.1. Start a window listener](./docs/WINDOW.md#321-start-a-window-listener)
      * [3.2.2. Pause a window listener](./docs/WINDOW.md#322-pause-a-window-listener)
      * [3.2.3. Resume a window listener](./docs/WINDOW.md#323-resume-a-window-listener)
      * [3.2.4. Stop a window listener](./docs/WINDOW.md#324-stop-a-window-listener)
* [**VIII. Sound Manager**](./docs/SOUND.md)
  ...
  * [2. Text-to-Speech (TTS)](./docs/SOUND.md#2-text-to-speech-tts)
    * [2.1. Speak a Text](./docs/SOUND.md#21-speak-a-text)
    * [2.2. Volume Management](./docs/SOUND.md#22-volume-management)
    * [2.3. Speed Management](./docs/SOUND.md#23-speed-management)
    * [2.4. Voice Management](./docs/SOUND.md#24-voice-management)
...
* [**XI. Filesystem Manager**](./docs/FILESYSTEM.md)
  ...
  * [2. File Verification](./docs/FILESYSTEM.md#2-file-verification)
    ...
    * [2.5. Check if a file is compressed](./docs/FILESYSTEM.md#25-check-if-a-file-is-compressed)
